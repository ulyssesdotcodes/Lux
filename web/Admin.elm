      ...
      True ->
        ...
        , div [class [Control]]
          ...
          , div [class [ControlGroup]]
            ...
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [3, 8, 9, 24] False )] [text "Film Vote 2"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [17] False )] [text "Film Vote 3"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 3, 7, 8, 9, 11, 19, 25, 20, 26, 23, 24, 17, 18, 28] False )] [text "Film Vote 4"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 3, 6, 9, 11, 19, 25, 20, 26, 23, 17, 18, 28] False )] [text "Film Vote 5"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 3, 8, 9, 11, 19, 25, 20, 26, 23, 17, 18, 28] False )] [text "Film Vote 6"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 11, 19, 25, 20, 26, 21, 27, 23, 17, 18, 28] False )] [text "Film Vote 7"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [3, 8, 19, 25, 20, 26, 21, 27, 17, 18, 28] False )] [text "Film Vote 8"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 11, 12, 19, 25, 20, 26, 21, 27, 23, 17, 18, 28, 29] True )] [text "Film Vote 9"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 12, 16, 19, 25, 20, 26, 21, 27, 23, 17, 18, 28, 29] True )] [text "Film Vote 10"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 12, 16, 19, 25, 20, 26, 21, 27, 23, 17, 18, 28, 29] True )] [text "Film Vote 11"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 12, 14, 16, 19, 25, 20, 26, 21, 27, 23, 17, 18, 28, 29 ] True )] [text "Film Vote 12"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 8, 9, 12, 14, 16, 19, 25, 20, 26, 21, 27, 23, 22, 17, 18, 28, 29] True )] [text "Film Vote 13"]
            , button [onClick (Send <| encodeOutMsg <| NextVote Film "" [1, 2, 3, 4, 6, 7, 8, 9, 12, 14, 16, 19, 25, 20, 26, 21, 27, 23, 22, 17, 18, 28, 29] True )] [text "Film Vote 14"]
