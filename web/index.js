...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {messages: a, votes: b, password: c, connected: d, location: e, votedNum: f};
	});
var _user$project$Main$Vote = function (a) {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'NewMessage':
				var _p9 = _p4._0;
				var _p6 = _user$project$Main$decodeInMsg(_p9);
				_v4_2:
				do {
					if (_p6.ctor === 'Ok') {
						if (_p6._0.ctor === 'Votes') {
							var _p8 = _p6._0._0;
							var _p7 = _elm_lang$core$Native_Utils.eq(model.votes, _p8);
							if (_p7 === true) {
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{votes: _p8, votedNum: _elm_lang$core$Maybe$Nothing}),
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: {ctor: '::', _0: _p9, _1: model.messages}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Password':
...
var _user$project$Main$init = function (loc) {
	return {
		...
		_1: A2(
			_elm_lang$core$Task$perform,
			_user$project$Main$Connect,
			_elm_lang$core$Task$succeed('password'))
	};
};
