...
var _user$project$Main$arrayAsTuple2 = F2(
	function (a, b) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			function (aVal) {
...
var _user$project$Main$generateId = A2(
	_elm_lang$core$Random$map,
	...
	A2(
		...
		A2(
			...
			A2(_elm_lang$core$Random$int, 65, 91))));
...
var _user$project$Main$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {localId: v.localId};
	});
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {messages: a, votes: b, password: c, connected: d, location: e, votedNum: f, savedModel: g};
	});
var _user$project$Main$SavedModel = function (a) {
	return {localId: a};
};
...
var _user$project$Main$Votes = F2(
	function (a, b) {
		return {ctor: 'Votes', _0: a, _1: b};
	});
	...
	var decodeVotes = A3(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(
				A2(_user$project$Main$arrayAsTuple2, _elm_lang$core$Json_Decode$string, _elm_lang$core$Json_Decode$int))),
		A2(
			_elm_lang$core$Json_Decode$field,
			'votedNum',
...
var _user$project$Main$SaveId = function (a) {
	return {ctor: 'SaveId', _0: a};
};
var _user$project$Main$saveGeneratedId = function (newId) {
	return _user$project$Main$SaveId(newId);
};
var _user$project$Main$ChooseVote = function (a) {
	return {ctor: 'ChooseVote', _0: a};
};
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _user$project$Main$class(
				{
					ctor: '::',
					_0: _user$project$SharedStyles$VotesGroup,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('LUX wants '),
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(' to have the most '),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('FUN'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$ChooseVote(i)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p6.ctor) {
				...
				if (_p7.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								votedNum: _elm_lang$core$Maybe$Just(_p8)
							}),
						_1: _elm_lang$core$Native_Utils.eq(model.votedNum, _elm_lang$core$Maybe$Nothing) ? A2(
							_elm_lang$websocket$WebSocket$send,
							_user$project$Main$wsloc(model.location),
							_user$project$Main$encodeOutMsg(
								A2(_user$project$Main$Vote, _p7._0.localId, _p8))) : _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_elm_lang$core$Random$generate, _user$project$Main$saveGeneratedId, _user$project$Main$generateId)
					};
				}
			case 'Connect':
				var _p9 = model.savedModel;
				if (_p9.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							...
							_user$project$Main$wsloc(model.location),
							_user$project$Main$encodeOutMsg(
								_user$project$Main$Connecting(_p9._0.localId)))
					};
				} else {
					return {
						ctor: '_Tuple2',
			...
			case 'NewMessage':
				var _p13 = _p6._0;
				var _p10 = _user$project$Main$decodeInMsg(_p13);
				if (_p10.ctor === 'Ok') {
					var _p12 = _p10._0._0;
					var _p11 = _elm_lang$core$Native_Utils.eq(model.votes, _p12);
					if (_p11 === true) {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{votes: _p12, votedNum: _p10._0._1}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: {ctor: '::', _0: _p13, _1: model.messages}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				var newModel = _user$project$Main$SavedModel(_p6._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							savedModel: _elm_lang$core$Maybe$Just(newModel)
						}),
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						A2(_elm_lang$core$Json_Decode$field, 'localId', _elm_lang$core$Json_Decode$string))),
				_1: {ctor: '[]'}
			}
		}));
